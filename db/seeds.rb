...
product = Product.new(name: "pencil", price: 1, description: "A really great pencil", supplier_id: supplier.id)
product.save!
...
product = Product.new(name: "pen", price: 2, description: "A nice pink pen", supplier_id: supplier.id)
product.save!
